...
public class MainMenu {
  ...
  private static void menuCrearPedido(Scanner scanner) {
    ...
    do {
      ...
      switch (opcion) {
        ...
        case 6 -> {
          pedidoService.cancelarPedido(nuevoPedido);
          System.out.println("Cancelando pedido y volviendo al menú de manejo de pedidos...");
        }
        default -> System.out.println("Opción inválida. Intente nuevamente.");
      }
  ...
  private static void menuAgregarProductoPedido(Scanner scanner, Pedido nuevoPedido) {
    ...
    do {
      ...
      switch (opcion) {
        case 1 -> {
          // leo el id del producto, verifico si existe, luego pido la cantidad y verifico si hay stock, si es asi agrego, sino muestro error.
        }
        case 2 -> System.out.println("Volviendo al menú de crear pedido...");
        default -> System.out.println("Opción inválida. Intente nuevamente.");
      }
